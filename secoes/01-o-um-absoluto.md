...
### 2. `Um (absoluto) — Grande Atrator/um_absoluto_forma_canonica.md` — bytes 14.793–15.815
...
### 4. `Um (absoluto) — Grande Atrator/um_absoluto_pt.txt` — bytes 47.314–48.601
