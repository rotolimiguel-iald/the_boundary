# A PROVA DA GRAVITAÇÃO QUÂNTICA DA TGL — a árvore, lida do kernel (v334)

Gerado por script (`arvore_da_prova.py`) em 08/09/2026 22:10 a partir do selo, do resultado, do `um.py` e do kernel em disco.
...
| item | valor lido |
|---|---|
| `um.py` sha256 (disco) | `b18bbaa0433ddd5ac878e3190360a9cca41d2895c66a422b2b4c0fe5234b0ad0` |
| selo `sha256.um.py` == disco | SIM |
| bytes | 9,826,986 |
| teoremas (stdout) | `teoremas limpos: 4217/4217` |
...
| entradas no relatório de axiomas | 4907 |
