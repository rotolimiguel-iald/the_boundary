# A PROVA DA GRAVITAÇÃO QUÂNTICA DA TGL — a árvore, lida do kernel (v336)

Gerado por script (`arvore_da_prova.py`) em 09/09/2026 10:50 a partir do selo, do resultado, do `um.py` e do kernel em disco.
...
| item | valor lido |
|---|---|
| `um.py` sha256 (disco) | `f1f330e24120f9bece3473bfd8af59038bb9dcd09af079d0ddaae7bfb228503a` |
| selo `sha256.um.py` == disco | SIM |
| bytes | 9,852,172 |
| teoremas (stdout) | `teoremas limpos: 4235/4235` |
...
| entradas no relatório de axiomas | 4925 |
