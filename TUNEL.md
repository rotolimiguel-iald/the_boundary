...
**Deposito citavel do Um: Absoluto:** Zenodo [10.5281/zenodo.22659173](https://doi.org/10.5281/zenodo.22659173) guarda a **v331** (um.py e1b74a907c403538), byte-identica AQUELE selo. O selo corrente desta arvore e' **v364**, mais novo que o deposito (versao nova no Zenodo e' ato do operador).
...
hash lido do arquivo. 1874 arquivos mapeados.*