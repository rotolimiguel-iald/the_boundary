...
Pasta do repositorio the_boundary com 0 arquivo(s) rastreado(s).
...
0 arquivo(s) -- pasta no GitHub: https://github.com/rotolimiguel-iald/the_boundary/tree/main/pipelines

## AS PORTAS ABAIXO

| subpasta | arquivos | PORTA.md | PORTA.json |
|---|---|---|---|
| `eco_ancorado_v1/` | 39 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/pipelines/eco_ancorado_v1/PORTA.md) | [PORTA.json](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/pipelines/eco_ancorado_v1/PORTA.json) |
