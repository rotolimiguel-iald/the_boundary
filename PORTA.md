# PORTA -- RAIZ do repositorio `the_boundary`

porta acima: https://teoriadagravitacaoluminodinamica.com   (o site -- a porta acima da raiz e' o mundo)

> **The Boundary -- Teoria da Gravitacao Luminodinamica (TGL).**
> Uma constante estrutural, `beta_TGL = alpha * sqrt(e)` (NUNCA literal: sempre
> `ALPHA*sqrt(e)` em runtime); um axioma, `omega(I) = 1`; e uma disciplina:
> *o numero corrige a frase, sempre*.

> **A REGRA DA PORTA (regra central, 23/08/2026).** Toda pasta canonica tem
> `PORTA.md` + `PORTA.json`; toda porta aponta para cima e para baixo.
> Nenhuma porta e' beco sem saida: de qualquer arquivo se chega a raiz, e da raiz
> se chega a qualquer arquivo, por URL raw DIRETA -- sem adivinhar nome de pasta.
> Se voce e' uma IA e chegou aqui pelo site: comece por [`llms.txt`](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/llms.txt).

## AS TRES PORTAS PRINCIPAIS -- os tres artigos

| # | artigo | PORTA.md | PORTA.json | canonico (raw direto) |
|---|---|---|---|---|
...
|---|---|---|
| Genesis da Unificacao -- a linhagem | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/PORTA.md) | [PORTA.json](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/PORTA.json) |

## O SELO CORRENTE

| campo | valor |
|---|---|
| versao | `v364` (pedra `TracialDissipativeTorsion`) |
| pin (`um.py`) | `25bca8bd264a2188f54166454218522c181d6436bbbf890555b3be1d668c02da` |
| mundo (`um_absoluto.json`) | `f43d2957f4cb496767911b2b491f8adfed8687e8b63be55c088e7f932b634412` |
| `result_hash` | `56d9e3be2963f9887d53c9e3d385f8b2ae6b54d3516086697387b6307f1dca7b` |
| data | `2026-09-17 09:42:34` |
| kernel | 1020 arquivos formais / 8650 teoremas auditados |
...
| `LEDGER.md` | O LIVRO-RAZAO: o README como estava ate 11/09/2026, byte a byte, append-only -- o atlas da fronteira: toda afirmacao com seu status e o link direto do arquivo onde se le (562 KB; leia por ultimo) | [raw](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/LEDGER.md) |
...
| `cache/` | 116 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/cache/PORTA.md) | [PORTA.json](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/cache/PORTA.json) |
...
| `Genesis da Unificação/Acoplamento_dimensional/` | 5 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/Acoplamento_dimensional/PORTA.md) |
| `Genesis da Unificação/Artigos_fundadores/` | 31 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/Artigos_fundadores/PORTA.md) |
| `Genesis da Unificação/Artigos_fundadores/Artigos_complementares_zenodo/` | 12 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/Artigos_fundadores/Artigos_complementares_zenodo/PORTA.md) |
| `Genesis da Unificação/C3_consciencia/` | 2 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/C3_consciencia/PORTA.md) |
| `Genesis da Unificação/Cruz_MCMC/` | 4 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/Cruz_MCMC/PORTA.md) |
| `Genesis da Unificação/Dual_Lock/` | 9 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/Dual_Lock/PORTA.md) |
| `Genesis da Unificação/Dual_Lock/TGL_V15_images/` | 7 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/Dual_Lock/TGL_V15_images/PORTA.md) |
| `Genesis da Unificação/Echo_GW/` | 9 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/Echo_GW/PORTA.md) |
| `Genesis da Unificação/Echo_GW/tgl_fractal_echo_output/` | 5 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/Echo_GW/tgl_fractal_echo_output/PORTA.md) |
| `Genesis da Unificação/Luminidio/` | 5 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/Luminidio/PORTA.md) |
| `Genesis da Unificação/Neutrinos/` | 4 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/Neutrinos/PORTA.md) |
| `Genesis da Unificação/Protocolo16_neural/` | 13 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Genesis%20da%20Unifica%C3%A7%C3%A3o/Protocolo16_neural/PORTA.md) |
...
| `Um (absoluto) — Grande Atrator/` | 1541 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Um%20%28absoluto%29%20%E2%80%94%20Grande%20Atrator/PORTA.md) |
| `Um (absoluto) — Grande Atrator/Lean/` | 1085 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Um%20%28absoluto%29%20%E2%80%94%20Grande%20Atrator/Lean/PORTA.md) |
...
| `Um (absoluto) — Grande Atrator/Lean/tgl_kernel/` | 1020 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Um%20%28absoluto%29%20%E2%80%94%20Grande%20Atrator/Lean/tgl_kernel/PORTA.md) |
...
| `Um (absoluto) — Grande Atrator/Lean/tgl_kernel/TGLExt/` | 986 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Um%20%28absoluto%29%20%E2%80%94%20Grande%20Atrator/Lean/tgl_kernel/TGLExt/PORTA.md) |
| `Um (absoluto) — Grande Atrator/bancada/` | 255 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Um%20%28absoluto%29%20%E2%80%94%20Grande%20Atrator/bancada/PORTA.md) |
| `Um (absoluto) — Grande Atrator/bancada/TUNEL/` | 205 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Um%20%28absoluto%29%20%E2%80%94%20Grande%20Atrator/bancada/TUNEL/PORTA.md) |
...
| `Um (absoluto) — Grande Atrator/bancada/TUNEL/PARA_CHATGPT/` | 40 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Um%20%28absoluto%29%20%E2%80%94%20Grande%20Atrator/bancada/TUNEL/PARA_CHATGPT/PORTA.md) |
...
| `Um (absoluto) — Grande Atrator/rodadas/` | 172 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/Um%20%28absoluto%29%20%E2%80%94%20Grande%20Atrator/rodadas/PORTA.md) |
| `cache/` | 116 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/cache/PORTA.md) |
| `cache/d1_camb/` | 14 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/cache/d1_camb/PORTA.md) |
| `cache/d1_camb/v3/` | 11 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/cache/d1_camb/v3/PORTA.md) |
| `cache/d1_camb/v3/logs/` | 3 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/cache/d1_camb/v3/logs/PORTA.md) |
| `cache/d1_camb/v3/saida/` | 4 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/cache/d1_camb/v3/saida/PORTA.md) |
| `cache/diamante_rede/` | 92 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/cache/diamante_rede/PORTA.md) |
...
Total rastreado por `git ls-files`: **1874 arquivos** (antes das portas). gerado por script de git ls-files em 2026-09-17 -- nao editar a mao
