...
0 arquivo(s) -- pasta no GitHub: https://github.com/rotolimiguel-iald/the_boundary/tree/main/.github

## AS PORTAS ABAIXO

| subpasta | arquivos | PORTA.md | PORTA.json |
|---|---|---|---|
| `workflows/` | 1 | [PORTA.md](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/.github/workflows/PORTA.md) | [PORTA.json](https://raw.githubusercontent.com/rotolimiguel-iald/the_boundary/main/.github/workflows/PORTA.json) |
